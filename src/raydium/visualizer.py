...
<head>
    ...
    <title>Raydium — Indian Solar Plant Siting & Site Selection Platform</title>
...
<body class="bg-slate-950 text-slate-100 font-sans antialiased overflow-hidden flex flex-col h-screen">
    ...
    <header class="h-16 bg-slate-900 border-b border-slate-800 px-6 py-2.5 flex items-center justify-between z-30">
        <div class="flex items-center space-x-3.5">
            ...
            <div>
                <div class="flex items-center gap-2">
                    ...
                    <span class="text-[10px] font-mono bg-emerald-500/20 text-emerald-300 px-2 py-0.5 rounded border border-emerald-500/30">PRECISION SITING</span>
                    <span class="text-[11px] text-slate-400 font-normal hidden sm:inline">— Candidate Solar Park Zones for India</span>
                </div>
            </div>
        </div>
        ...
        <div class="hidden md:flex items-center space-x-3 text-xs">
            <label class="text-slate-400 text-[11px] font-medium flex items-center gap-1.5">
                <i data-lucide="target" class="w-3.5 h-3.5 text-emerald-400"></i> Zoom to Site:
            </label>
        ...
        <div class="flex items-center space-x-2.5">
            <button onclick="toggleSidePanel()" class="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-slate-800 hover:bg-slate-700 text-xs font-medium text-slate-200 border border-slate-700 transition">
                <i data-lucide="sliders" class="w-3.5 h-3.5 text-amber-400"></i> Feasibility Tool
            </button>
            <button onclick="downloadCSV()" class="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-emerald-600 hover:bg-emerald-500 text-xs font-medium text-white font-semibold shadow-sm transition">
                <i data-lucide="download" class="w-3.5 h-3.5"></i> Export Candidate Sites
            </button>
        </div>
    </header>
    ...
    <div class="relative flex-1 w-full overflow-hidden">
        ...
        <div class="absolute bottom-6 left-6 z-20 glass-panel rounded-xl p-4 shadow-xl max-w-xs w-full text-xs">
            <div class="flex items-center justify-between mb-2.5">
                <h4 class="font-semibold text-slate-200 uppercase tracking-wider text-[11px]">Map Layers & Legend</h4>
            ...
            <div class="pt-2.5 border-t border-slate-800 space-y-2">
                <div class="flex justify-between items-center text-[11px]">
                    <span class="text-slate-400">Basemap Mode:</span>
                    <div class="flex rounded bg-slate-800 p-0.5 text-[10px]">
                        <button id="btnDark" onclick="switchBasemap('dark')" class="px-2 py-0.5 rounded bg-slate-700 text-white font-medium">Dark GIS</button>
                ...
                <div>
                    <div class="flex justify-between text-slate-400 text-[10px] mb-1">
                        <span>Solar Surface Transparency</span>
        ...
        <!-- Floating Siting Feasibility & Dossier Drawer (Right Side) -->
                ...
                <div class="flex items-center justify-between pb-3 border-b border-slate-800 mb-3.5">
                    <div>
                        <h3 class="font-semibold text-slate-100 text-sm flex items-center gap-2">
                            <i data-lucide="award" class="w-4 h-4 text-emerald-400"></i> Site Feasibility Dossier
                        </h3>
    ...
    <script>
        ...
        function initMap() {
            ...
            surfaceOverlay = L.imageOverlay(SURFACE_PNG, SURFACE_BOUNDS, {
                opacity: 0.75,
                interactive: false,
                crossOrigin: true,
                zIndex: 5
